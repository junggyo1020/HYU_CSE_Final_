...
from src.dataset_to_txt import save_wmt_to_txt
from visualize import visualize_scores
from dataset_to_txt import save_wmt_to_txt, save_squad_to_txt, save_cnn_to_txt
...
save_wmt_to_txt(wmt_dataset) # WMT 데이터셋을 텍스트 파일로 저장
...
save_squad_to_txt(squad_contexts) # SQuAD 데이터셋을 텍스트 파일로 저장
...
save_cnn_to_txt(cnn_articles) # CNN 데이터셋을 텍스트 파일로 저장
