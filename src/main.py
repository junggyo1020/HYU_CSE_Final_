...
from evaluate_metrics import calculate_bleu, calculate_rouge, calculate_bert_score, calculate_weighted_bleu, calculate_combined_metric
...
# 점수 시각화
visualize_scores(bleu_scores, rouge_scores, bert_scores, weighted_bleu_scores, combined_scores)
